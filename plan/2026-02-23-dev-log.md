...
**Follow-up note: This was nice on the first day of the project - but the rest of the development has been broken up in random-length chunks over several days. Best to just review the `./questions.md` doc for progress, perhaps comparing to `./plan.md` implementation notes.**
